...
curl -L http://localhost/test/1234 -X POST -H "Accept: application/json" -H "Content-Type: application/json" -d ""
curl -L http://localhost/test/1234 -X POST -H "Accept: application/json" -H "Content-Type: application/garbage" -d ""
